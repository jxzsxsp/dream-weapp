...
Page((a = {
        ...
        BuyProduct: function(t) {
            var a = this,
                ...
                s = t.currentTarget.dataset.productid,
                r = a.data.ProductList;
        ...
        onSkuClick: function(t) {
            var a = t.target.dataset.indexcount,
                e = t.target.id,
                n = t.target.dataset.skuvalue,
                u = new Object();
            ...
            var r = "",
                ...
                o = this.data.CurrentProduct.SkuItems;
            ...
            if (null != this.data.SkuItemList && a.data.selectedskuList.length == this.data.SkuItemList.length && e)
                if (a.data.buyAmount <= 0) wx.showModal({
                    ...
                    var u = this.data.buyAmount,
                        s = (this.data.selectedSku, this.data.ProductList);
                    s.find(function(t, e) {
